//! [`ReadSamples`] and [`PollOutput`], the verbs every driver takes its layers by, and the [`Demuxer`] and [`Muxer`] over `futures::io`
//!
//! The two traits are what both halves of the crate drive their layers
//! through; the loops are written apart, and the ones over `std::io` are in
