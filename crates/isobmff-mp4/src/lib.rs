...
//! MP4 file format
//!
//! An MPEG-4 track describes its samples with an [`MP4AudioSampleEntry`]
//! (`mp4a`), an [`MP4VisualSampleEntry`] (`mp4v`), or an [`MpegSampleEntry`]
//! (`mp4s`) for any other stream type, each holding an [`ESDBox`] (`esds`)
//! around the [`ESDescriptor`] of ISO/IEC 14496-1. The descriptor tree is read down to
...
pub use mp4v::MP4VisualSampleEntry;
