...
pub enum SampleErrorKind {
    ...
    /// [`track_id`](crate::SampleError::track_id) is the track the sample
    /// belongs to, and
    /// [`established_track_id`](crate::SampleError::established_track_id) the
    /// one the chunk holds.
    TrackIdMismatch,
    ...
    /// is refused.
    /// [`track_id`](crate::SampleError::track_id) is the track it belongs to,
    /// and [`sample_flags`](crate::SampleError::sample_flags) the flags it
    /// states.
