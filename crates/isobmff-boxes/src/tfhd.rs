...
impl BoxDecode for TrackFragmentHeaderBox {
    ...
    /// * [`Field`](DecodeError::Field): the payload ends inside a field the
    ///   flags state, or holds bytes past the fields they state.
...
mod tests {
    ...
    use isobmff_core::{BoxDecode, BoxEncode, DecodeError, FieldReadError, FullBoxFlags};
